...
static const char *brow1cmd[]  = { "google-chrome-stable", NULL };
static const char *hypcmd[]  = { "hypnotix", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F2,     spawn,          {.v = brow1cmd } },	
       	{ MODKEY,                       XK_F5,     spawn,          {.v = hypcmd } },
	{ MODKEY,                       XK_F6,     spawn,          {.v = mailcmd } },
